...
def start_text() -> str:
    return (
        ...
        "🎚 Битрейты WAV — WAV в 16/24-bit, 44.1/48/96 kHz\n"
...
PCM_MODE_TEXT = (
    "Режим: Битрейты WAV\n"
    "Отправь WAV (или другое аудио) — как трек или файлом.\n"
    "Затем выбери формат:\n"
    "• 44.1 kHz / 16-bit PCM\n"
    "• 44.1 kHz / 24-bit PCM\n"
    "• 48 kHz / 24-bit PCM\n"
...
PCM_DOWNLOADING_TEXT = "Получаю аудио, подожди..."
PCM_DOWNLOAD_ERROR_TEXT = (
    "Не удалось скачать аудио. Отправь файл ещё раз "
    "или пришли трек напрямую, без пересылки."
)
PCM_AUDIO_SAVED_TEXT = "Аудио получил. Выбери формат кнопкой ниже:"
PCM_PICK_FORMAT_TEXT = "Выбери формат кнопкой ниже:"
PCM_NO_AUDIO_TEXT = "Сначала отправь аудио в режиме Битрейты WAV."
PCM_CONVERTING_TEXT = "Конвертирую WAV..."
PCM_ERROR_TEXT = "Не удалось сконвертировать. Проверь, что файл валидный."
PCM_INVALID_AUDIO_TEXT = "Нужен аудиофайл (WAV, MP3 и др.)."
def pcm_success_caption(label: str) -> str:
    return f"Готово: WAV {label}"
RINGTONE_MODE_TEXT = (
    "Режим: Рингтон\n"
...
WRONG_MODE_PCM_TEXT = "Сейчас активен другой режим. Нажми 🎚 Битрейты WAV или 🏠 Меню."
