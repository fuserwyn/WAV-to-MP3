...
def start_text() -> str:
    return (
        ...
        "🖼 Обложка — фото → JPG 3000–10000 px (файлом)\n"
        "✨ Генерация обложки — промпт или своё фото → Nano Banana 3000×3000\n"
...
COVER_GEN_NO_IMAGE_TEXT = (
    "Сначала сгенерируй обложку или пришли фото через ✨ Генерация обложки."
)
